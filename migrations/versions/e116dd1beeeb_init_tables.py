...
Revision ID: e116dd1beeeb
Revises: 
Create Date: 2019-03-04 22:06:31.110578
...
def upgrade():
    ...
    op.create_table('ys_user_profile',
    ...
    sa.ForeignKeyConstraint(['area_id'], ['ys_area_info.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['ys_user_profile.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('ys_facility_info',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_ys_order_info_status'), 'ys_order_info', ['status'], unique=False)
    op.create_table('ys_house_facility',
    sa.Column('house_id', sa.Integer(), nullable=False),
    sa.Column('facility_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['facility_id'], ['ys_facility_info.id'], ),
    sa.ForeignKeyConstraint(['house_id'], ['ys_hosue_info.id'], ),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('ys_house_facility')
    op.drop_index(op.f('ix_ys_order_info_status'), table_name='ys_order_info')
    op.drop_table('ys_order_info')
    op.drop_table('ys_facility_info')
    op.drop_table('ys_hosue_info')
    op.drop_table('ys_user_profile')
    # ### end Alembic commands ###
